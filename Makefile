...
###
###-----------------------------------------------------------------------------
INCLUDE = -I"C:\folder_jon\OpenCV-MinGW-Build-OpenCV-4.1.1-x64\include"
LIBRARIES = -L"C:\folder_jon\OpenCV-MinGW-Build-OpenCV-4.1.1-x64\x64\mingw\lib" -llibopencv_core411 -llibopencv_highgui411 -llibopencv_imgcodecs411 -llibopencv_imgproc411
